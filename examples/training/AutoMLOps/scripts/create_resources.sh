...
PROJECT_ID=sandbox-allegranoto
PROJECT_NUMBER=`gcloud projects describe sandbox-allegranoto --format 'value(projectNumber)'`
BUCKET_NAME=sandbox-allegranoto-bucket
BUCKET_LOCATION=us-central1
SERVICE_ACCOUNT_NAME=vertex-pipelines
SERVICE_ACCOUNT_FULL=vertex-pipelines@sandbox-allegranoto.iam.gserviceaccount.com
