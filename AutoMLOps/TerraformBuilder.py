...
def _create_iam():
    ...
    return (
       ...
       f'resource "google_service_account" "pipeline_service_account" {LEFT_BRACKET}\n'
       f'  project                 = var.project_id\n'
       ...
       f'{RIGHT_BRACKET}\n'
       f'\n'
       f'# Create cloud build runner service account\n'
       f'resource "google_service_account" "cloudbuild_service_account" {LEFT_BRACKET}\n'
       f'  project                 = var.project_id\n'
       f'  account_id              = var.cloudbuild_runner_sa\n'
       ...
       f'  depends_on              = [google_service_account.pipeline_service_account]\n'
       f'  project_roles           = [\n'
       ...
       f'  project_id              = var.project_id\n'
       f'  prefix                  = "serviceAccount"\n'
       f'  service_account_address = "${LEFT_BRACKET}var.cloudbuild_runner_sa{RIGHT_BRACKET}@${LEFT_BRACKET}var.project_id{RIGHT_BRACKET}.iam.gserviceaccount.com"\n'
       f'  depends_on              = [module.google_project_service, google_service_account.cloudbuild_service_account]\n'
       f'  project_roles           = [\n'
       f'    "roles/run.admin",\n'
       f'    "roles/iam.serviceAccountUser",\n'
...
def _create_variables(run_local: bool):
    ...
    variables = (
       ...
       f'  description   = "Name of pipeline runner service account"\n'
       f'  type          = string\n'
       f'  default       = "vertex-pipelines"\n'
       f'\n'
       f'{RIGHT_BRACKET}\n'
       f'variable "cloudbuild_runner_sa" {LEFT_BRACKET}\n'
       f'  description   = "Name of cloudbuild runner service account"\n'
       f'  type          = string\n'
       f'  default       = "cloudbuild-trigger"\n'
       f'{RIGHT_BRACKET}\n'
       f'\n'
